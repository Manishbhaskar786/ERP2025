...
namespace ERPack.Web.Controllers
{
    public class AccountController : ERPackControllerBase
    {
        ...
        public virtual async Task<JsonResult> Login(LoginViewModel loginModel, string returnUrl = "", string returnUrlHash = "")
        {
            ...
            if(loginResult.Identity.GetTenantId() == null)
            {
                return Json(new AjaxResponse { TargetUrl = "/Tenants/Index" });
            }
        ...
        private async Task<AbpLoginResult<Tenant, User>> GetLoginResultAsync(string usernameOrEmailAddress, string password, string tenancyName)
        {
            ...
            {
                tenancyName = await GetTenantNameByUsernameOrEmailAsync(usernameOrEmailAddress);
            }
        ...
        private async Task<string> GetTenantNameByUsernameOrEmailAsync(string usernameOrEmail)
        {
            // Query the user by email/username and resolve the tenant name
            ...
            {
                // Assuming you have a TenantId or TenancyName in your User entity
                var tenant = await _tenantManager.GetByIdAsync(user.TenantId ?? 0);
